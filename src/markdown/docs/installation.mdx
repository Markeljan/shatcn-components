---
title: Installation
description: Learn how to install shatcn components.
---
...
<Warning className="mt-8 mb-4" description="Shatcn components doesn't support utility class components anymore, only css variables components. Also, it doesn't matter which baseColor you choose, because it doesn't change the styling." />
...
After you're done you'll come back to shatcn button page, and copy button component to your project inside `components/ui/button.tsx``
(this is the default component path) or your custom component path.

Keep in mind that shatcn components can have different variants than default shadcn components.
