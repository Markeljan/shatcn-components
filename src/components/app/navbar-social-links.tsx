...
export function NavbarSocialLinks({ starsCount }: { starsCount: number }) {
    ...
    return (
        <>
            <a
                ...
                onClick={(e) => handleLinkClick(e, "https://github.com/markeljan/shatcn-components")}
            ...
            <a
                ...
                onClick={(e) => handleLinkClick(e, "https://twitter.com/samuelbreznjak")}
